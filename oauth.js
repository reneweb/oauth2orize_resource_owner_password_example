...
server.exchange(oauth2orize.exchange.password(function (client, username, password, scope, done) {
    ...
    db.collection('accessTokens').save({token: tokenHash, refreshToken: refreshTokenHash, expirationDate: expirationDate, clientId: client._id, username: username, scope: scope}, function (err) {
